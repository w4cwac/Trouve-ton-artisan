        ...
        <>
            ...
            <section className="d-flex flex-column align-items-center">
                <article className="d-flex flex-column justify-content-center align-items-center" >
                    <h2 className="text-dark text-center">Entreprises de Fabrication</h2>
                ...
                <article className="article-batiment w-100 d-flex flex-column justify-content-center align-items-center">
                    <div className="d-flex flex-column flex-md-row justify-content-center align-items-center align-items-md-stretch col-12 col-md-11 gap-2 p-2 mt-2 mb-2">
                        {
                            data.filter((val) => {
